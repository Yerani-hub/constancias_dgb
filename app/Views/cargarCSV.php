                        ...
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <div class="collapse" id="collapseDashboards" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                                    <a class="nav-link nav-link-icon" href=""><i class="me-2" data-feather="file-plus"></i>Nuevas...</a>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6 mb-4">
                                                    ...
                                                    <input class="form-control" type="file" id="formFile" name="archivo_csv">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="alert alert-cyan " role="alert">El archivo se ha cargado con éxito.</div>
                                                        <div class="alert alert-red mb-0" role="alert">Error al cargar el archivo. Favor intentarlo de nuevo.</div>
                                                    </div>
